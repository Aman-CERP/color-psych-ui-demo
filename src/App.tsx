...
const getChartData = (currentKey: PaletteKey) => {
  return [
...
const App: React.FC = () => {
  ...
  const chartData = getChartData(currentPaletteKey);
          ...
          <div className="card p-6">
            <ResponsiveContainer width="100%" height={320}>
              <BarChart data={chartData} barCategoryGap={24}>
                ...
                <XAxis dataKey="palette" tick={{ fill: 'var(--text-muted)', fontSize: 12 }} />
                ...
                />
                <Bar dataKey="calmness" name="Calmness Score" fill="var(--accent)" radius={6} />
                <Bar dataKey="premium" name="Premium Feel" fill="var(--accent-light)" radius={6} opacity={0.7} />
              </BarChart>
            </ResponsiveContainer>
